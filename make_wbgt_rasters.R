...
source(paste0(script_path,"calculate_dew_point.R")) # for WBGT

make_wbgt_rasters <- function(site, year, landcover, position, scenario){
  ...
  f <- function(MRT, Tair, RH, U) {
    ...
    return(calculate_wbgt(t2_k,MRT,va,td_k))
